...
const CreateTask: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  ...
  <div  className="flex justify-between items-center mb-4"> 
    ...
    <button type="submit" data-testid="create-task-modal" className="w-full p-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition duration-300">
      Add Task
    </button>
  </form>
   </div>
